...
- React adding a `<div id="root">` to wrap all my content had so many unintended consequences
  - No matter what I tried, there was always scroll to the screen. Even with setting height to 100%
  - Getting the content to center on the screen was very difficult
